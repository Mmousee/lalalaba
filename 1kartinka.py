...
def kust(x1, y1, size):
    ...
    for i in range (5):
        ...
        ellipse (screen, (255,255,255), (x1+size*1+size*i*a,y1-size*17/10+size*i*b, size*5,size*3))
        ellipse (screen, (1,1,1), (x1+size*1+size*i*a,y1-size*17/10+size*i*b, size*5,size*3),1)
        ...
        ellipse (screen, (255,255,255), (x1+size*3+size*i*a,y1+size*2+size*i*b,size*5,size*3))
        ellipse (screen, (1,1,1), (x1+size*3+size*i*a,y1+size*2+size*i*b,size*5,size*3),1)
        ellipse (screen, (255,255,255), (x1-size*7/2+size*i*a,y1+size*4/3+size*i*b,size*5,size*3))
        ellipse (screen, (1,1,1), (x1-size*7/2+size*i*a,y1+size*4/3+size*i*b,size*5,size*3),1)
        ellipse (screen, (255,255,255), (x1-size*1+size*i*a,y1+size*21/10+size*i*b, size*5,size*3))
        ellipse (screen, (1,1,1), (x1-size*1+size*i*a,y1+size*21/10+size*i*b, size*5,size*3),1)
